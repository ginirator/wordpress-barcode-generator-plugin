...
<body onload="window.print();">
	<div style="margin-left: 5%">
		<?php
			...
			$print_qty = intval($_POST['print_qty']); // Ensure that this is an integer

			for ($i=1; $i<=$print_qty; $i++) {
				echo "<p class='inline'><span ><b>$product</b></span>".bar128(stripcslashes($product_id))."<span ><b>".$rate." </b><span></p>&nbsp&nbsp&nbsp&nbsp";
			}
		?>
	</div>
</body>
